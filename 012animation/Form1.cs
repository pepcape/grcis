...
namespace _012animation
{
  public partial class Form1 : Form
  {
    ...
    public Form1 ()
    {
      ...
      double from, to, fps;
      Animation.InitParams(out string name, out ImageWidth, out ImageHeight, out from, out to, out fps);
      if (ImageWidth  < 0)
    ...
    protected void RenderWorker ()
    {
      ...
      while (true)
      {
        ...
        r.image = Animation.RenderFrame(width, height, myTime, start, end);
