namespace _048rtmontecarlo
{
  partial class AdvancedToolsForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.PrimaryRaysMapPanel.Controls.Add(this.RenderPrimaryRaysMapButton);
      ...
      this.AllRaysMapPanel.Controls.Add(this.RenderAllRaysMapButtona);
      ...
      this.NormalMapRelativePanel.Controls.Add(this.RenderNormalMapRelativeButton);
      ...
      this.NormalMapAbsolutePanel.Controls.Add(this.RenderNormalMapAbsoluteButton);
      ...
      this.RenderPrimaryRaysMapButton.TabIndex = 12;
      this.RenderPrimaryRaysMapButton.Tag = "";
      ...
      this.RenderAllRaysMapButtona.TabIndex = 14;
      this.RenderAllRaysMapButtona.Tag = "";
      ...
      this.RenderNormalMapRelativeButton.TabIndex = 17;
      this.RenderNormalMapRelativeButton.Tag = "";
      ...
      this.RenderNormalMapAbsoluteButton.TabIndex = 17;
      this.RenderNormalMapAbsoluteButton.Tag = "";
