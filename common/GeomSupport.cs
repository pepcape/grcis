...
namespace MathSupport
{
  ...
  public class Geometry
  {
    ...
    public static Vector3 UnProject ( ref Matrix4 projection, ref Matrix4 view, int width, int height, float x, float y,
                                      float       z = 0.0f )
    {
      Vector4 vec;
    ...
    public static bool RayBoxIntersection ( ref Vector3d p0, ref Vector3d p1, ref Vector3d ul, ref Vector3d size,
                                            out Vector2d result )
    {
      result.X =
        result.Y = -1.0;
    ...
    /// <param name="result">Parameter (t) bounds: [min, max].</param>
    /// <returns>True if intersections exist.</returns>
    public static bool RayBoxIntersectionInv ( ref Vector3d p0, ref Vector3d p1inv, ref Vector3d ul, ref Vector3d size,
                                               out Vector2d result )
    {
      result.X =
        result.Y = -1.0;
    ...
    /// <param name="result">Parameter (t) bounds: [min, max].</param>
    /// <returns>True if intersections exist.</returns>
    public static bool RayBoxIntersectionInv ( ref Vector3d p0, ref Vector3d p1inv, ref Vector3 ul, ref Vector3 size,
                                               out Vector2d result )
    {
      result.X =
        result.Y = -1.0;
