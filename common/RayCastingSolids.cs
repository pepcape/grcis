...
namespace Rendering
{
  ...
  public class Torus: DefaultSceneNode, ISolid
  {
    ...
    private Vector3d getSmallCircleCenter ( Intersection inter )
    {
      ...
      double torusCenter_intersectionDistanceInPlane =
        Math.Sqrt ( inter.CoordLocal.X * inter.CoordLocal.X + inter.CoordLocal.Y * inter.CoordLocal.Y );
  ...
  public class BezierSurface: DefaultSceneNode, ISolid
  {
    ...
    {
      get { return BezierPatch.Epsilon; }
