...
namespace _058marbles
{
  ...
  public class MarblesRenderer
  {
    ...
    public long Render ( OpenglState OGL, MarblesRenderData data )
    {
      ...
      Vector3 relEye = Vector3.TransformVector( OGL.eyePosition, modelViewInv );
      GL.UniformMatrix4( OGL.activeProgram.GetUniform( "matrixModelView" ), false, ref modelView );
      if ( OGL.perspective )
        GL.UniformMatrix4( OGL.activeProgram.GetUniform( "matrixProjection" ), false, ref OGL.perspectiveProjection );
      else
        GL.UniformMatrix4( OGL.activeProgram.GetUniform( "matrixProjection" ), false, ref OGL.ortographicProjection );
      ...
      GL.Uniform3( OGL.activeProgram.GetUniform( "eyePosition" ),   ref relEye );
  ...
  public class MarblesWorld
  {
    ...
    /// <summary>
    /// Update number of simulated marbles, marbles==Marbles is required.
    /// </summary>
    void UpdateMarbles ()
    {
      if ( marbles < Marbles )
  ...
  public class OpenglState
  {
    ...
    /// <summary>
    /// Pre-computed perspective projection matrix.
    /// </summary>
    public Matrix4 perspectiveProjection;

    /// <summary>
    /// Pre-computed orthographic projection matrix.
    /// </summary>
    public Matrix4 ortographicProjection;
    ...
    {
      return form.GetModelView();
    }

    public Matrix4 GetModelViewInv ()
    {
      return form.GetModelViewInv();
    }
